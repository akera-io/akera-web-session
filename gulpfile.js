...
var typedocOptions = require("./typedoc.json");
...
gulp.task("compile:tests", function () {
  return testProject.src().pipe(testProject()).pipe(gulp.dest("test"));
});
...
gulp.task(
  "test",
  gulp.series("cleanup", "compile", "clean:tests", "compile:tests", "run:tests")
);
gulp.task(
  "cover",
  gulp.series(
...
gulp.task("doc", gulp.series("clean:doc", "doc:task"));
